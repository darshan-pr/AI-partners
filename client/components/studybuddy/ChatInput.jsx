            ...
            <div className="flex  items-end gap-2 sm:gap-3 p-1 sm:p-2">
              ...
              <div className="flex-1 relative">
                <textarea
                  ...
                  className={`w-full resize-none border-0 bg-transparent focus:outline-none text-sm sm:text-base leading-6 placeholder:transition-colors pr-8 sm:pr-10 py-1 sm:py-2 ${
                    isDark 
