      ...
      {filesData?.orgInfo && (
        <div className="glass-card rounded-2xl p-6">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Class: {filesData.orgInfo?.class_sec || 'N/A'} • Semester: {filesData.orgInfo?.semester || 'N/A'} • Branch: {filesData.orgInfo?.branch || 'N/A'}
          </p>
          <p className="text-sm text-blue-600 dark:text-blue-400 mt-1">
            📋 Shared resources for your organization, branch, and semester
          </p>
        </div>
      )}
