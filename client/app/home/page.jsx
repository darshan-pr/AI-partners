...
export default function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Upload and organize your study materials for easy access.",
      actionText: "Access knowledge nest",
      gradient: "from-teal-400 to-blue-400 dark:from-teal-600 dark:to-blue-600"
    },
    {
      href: "/home/analytics",
    ...
    <ProtectedRoute>
      <div className={`min-h-screen relative overflow-hidden pt-16 transition-colors duration-300 ${isDark ? 'bg-black' : 'bg-gradient-to-br from-blue-50 via-white to-purple-50'} ${isDark ? 'dark' : ''}`}>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-5 py-8 ">
          ...
          <div className="grid md:grid-cols-3 mb-8 gap-6 mb-8 ">
